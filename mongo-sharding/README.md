...
Итог будет выглядеть ![примерно так](/mongo-sharding/screens/sharding-web.PNG)
...
Итог будет выглядеть ![примерно так](/mongo-sharding/screens/sharding-docs-percent.PNG)
